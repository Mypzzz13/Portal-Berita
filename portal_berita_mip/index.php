...
if (isset($_GET['kategori'])) {
    ...
    $whereKategori = "AND artikel.id_kategori = '$id_kategori'";
}
...
$artikel = mysqli_query($conn, "
    ...
    WHERE judul LIKE '%$search%' $whereKategori
    ORDER BY id_artikel DESC
");

// trending
$trending = mysqli_query($conn, "
    SELECT * FROM artikel ORDER BY views DESC LIMIT 4
");
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="menu">
                ...
                <ul class="navbar-nav me-auto">
                    ...
                    ?>
                        <li class="nav-item">
                            <a class="nav-link" href="?kategori=<?= $k['id_kategori']; ?>">
